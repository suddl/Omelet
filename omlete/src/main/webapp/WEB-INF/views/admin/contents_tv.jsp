                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="contentsBtn">
							...
							<form id="modifyForm" action="<c:url value='/omlete/admin/contents_modify_tv'/>" method="get">
							    <input type="hidden" name="contentsNo" id="hiddenContentsNo" value="">
							    <button type="submit" class="modifyContents">수정</button>
							</form>
							<form id="deleteForm" action="<c:url value='/admin/contents_remove_tv'/>" method="post">
							    <input type="hidden" name="contentsNo" id="deleteContentsNo" value=""> <!-- 수정된 부분 -->
							    <button type="submit" class="removeContents" style="margin-left:40px;">삭제</button>
							</form>
                        </div>
                        </div>
                        <div class="card-body">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        modifyButton.addEventListener('click', function(event) {
            ...
            if (checkedBoxes.length === 1) { // 수정은 한 번에 하나의 항목만 가능
                ...
                window.location.href = baseUrl + "/omlete/admin/contents_modify_tv?contentsNo=" + contentsNo; // 올바른 경로로 이동
            } else {
                alert('하나의 항목만 선택하세요.');
            }
        });
