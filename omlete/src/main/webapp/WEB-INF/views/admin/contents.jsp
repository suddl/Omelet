...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="contentsBtn">
                        	<button class="addContents" onclick="location.href='contents_add.jsp'";>추가</button> 
                        	<button class="deleteContents">삭제</button>
                        </div>
                        </div>
                        <div class="card-body">
    ...
    <script src="vendor/bootstrap/js_admin/bootstrap.bundle.min.js"></script>
